...
?>
<ol class="w-full md:w-3/4 p-6 space-y-6">
<div class="block">
                    <h1 class="text-4xl text-purple-600 font-semibold">SKILLS </h1>
                ...
                <li class="relative">
                    ...
                    <div class="mt-3 sm:pe-8">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Kurdish</h3>    
                        <p class="block mb-2 text-sm font-normal leading-none text-gray-0 dark:text-gray-500">Native </p>
                        <!-- <p class="text-base font-normal text-gray-500 dark:text-gray-400">Get started with dozens of web components and interactive elements.</p> -->
                    </div>
                    <div class="mt-3 sm:pe-8">
